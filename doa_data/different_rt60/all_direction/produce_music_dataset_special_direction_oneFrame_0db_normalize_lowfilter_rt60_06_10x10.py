...
if __name__ == '__main__':
    ...
    # 生成训练集
    all_time = time.time()
    in_path = '/home/work/TJ/data/train-clean-100/LibriSpeech/train-clean-100'
    out_path = '/home/ssd2/doa_data/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_rt60_06_mic10x10/train'
    print('#####################################################')
    print(in_path)
    print('------------------------->')
    print(out_path)
