...
def create_room_box(direction, file_path, m=8, n=8, c=343.0, fs=16000, nfft=512, room_dim=np.r_[10.0, 8.0],
                    jianju=0.005, snr=0):
...
if __name__ == '__main__':
    ...
    out_path = '/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_mic8x8/train'
    print('#####################################################')
    print(in_path)
    print('------------------------->')
    print(out_path)
