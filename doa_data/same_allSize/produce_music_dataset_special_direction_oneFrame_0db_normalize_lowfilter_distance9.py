...
def create_room_box(direction, file_path, m=6, n=6, c=343.0, fs=16000, nfft=512, room_dim=np.r_[10.0, 8.0],
                    jianju=0.009, snr=0):
...
if __name__ == '__main__':
    ...
    out_path = '/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_distance9/train'
    print('#####################################################')
    print(in_path)
    print('------------------------->')
    print(out_path)
