...
def create_room_box(direction, file_path, m=16, n=16, c=343.0, fs=16000, nfft=512, room_dim=np.r_[10.0, 8.0],
                    jianju=0.003, snr=0):
...
if __name__ == '__main__':
    ...
    # 生成训练集
    all_time = time.time()
    in_path = '/home/work3/tj/DOA_data/train_wav_txt/vad'
    out_path = '/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_distance3/train'
    print('#####################################################')
    print(in_path)
    print('------------------------->')
    print(out_path)
