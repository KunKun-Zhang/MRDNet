...
def create_room_box(direction, file_path, m=10, n=10, c=343.0, fs=4960, nfft=512, room_dim=np.r_[10.0, 8.0],
                    jianju=0.005, snr=0):
    ...
    # source_signal = librosa.resample(source_signal, 4960, 16000)
...
if __name__ == '__main__':
    ...
    # 生成训练集
    all_time = time.time()
    # in_path = 'G:\\以前外场声音数据\\SensIT\\BACKUP\\events\\runs'
    in_path = '/home/ssd02/以前外场声音数据/SensIT/BACKUP/events/runs'
    out_path = '/home/ssd01/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_mic10x10_car_dataset_no_resample_4960/train'
    print('#####################################################')
    print(in_path)
    print('------------------------->')
    print(out_path)
