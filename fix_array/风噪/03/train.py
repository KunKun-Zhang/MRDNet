...
def train_loop(net, opt, loss_fn):
    ...
    # train_data = WavDataset(file_path='G:\\soundID\\DOAdata\\all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_no_preprocess_lowfilter_mic10x10_brownnoise')
    train_data = WavDataset(file_path='/home/ssd2/doa_data/all_direction_oneFileAllDirection_onlySingleFrame_2200_5db_normalize_lowfilter_mic10x10_brownnoise/train')
    train_loader = DataLoader(dataset=train_data, batch_size=batch_size, num_workers=num_worker, shuffle=True,
                              pin_memory=True)

    # validation_data = WavDataset(file_path='G:\\soundID\\DOAdata\\all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_no_preprocess_lowfilter_mic10x10_brownnoise')
    validation_data = WavDataset(file_path='/home/ssd2/doa_data/all_direction_oneFileAllDirection_onlySingleFrame_2200_5db_normalize_lowfilter_mic10x10_brownnoise/validation')
    ...
    print("train")
    epochs = 2000
    path = '/home/work/TJ/DOA/save/pre/fix_array/0407_03'
