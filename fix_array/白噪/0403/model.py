...
# 特征交织再过MLP,train和validation都用

# ------------------------- Epoch 22 / 2000 -------------------------
# train_loss:277.6532,train_acc:0.1833,train_bias_acc:0.7337,train_error:2.1691
# validation_loss:406.0376,validation_acc:0.1500,validation_bias_acc:0.6316,validation_error:3.1787
...
class DifferentialNet1(nn.Module):
    ...
    def forward(self, real_imag):
        result = torch.zeros((real_imag.shape[0], 512, 6, 6), device=real_imag.device)
        occur_num = 5
