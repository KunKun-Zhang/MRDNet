...
# max 0.2888197600841522
# min -0.304124116897583
...
class WavDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # print(np.max(time_series), end=';')
        # time_series = self.make_noise(time_series, 0)
        # temp2 = np.max(time_series)
        # temp4 = np.min(time_series)
        # print(temp1, temp2, temp3, temp4)
        # time_series = np.clip(time_series, 0.29, -0.31)
