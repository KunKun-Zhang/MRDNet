...
# ------------------------- Epoch 23 / 2000 -------------------------
# train_loss:147.1313,train_acc:0.3182,train_bias_acc:0.9309,train_error:1.1494
# validation_loss:225.8098,validation_acc:0.2317,validation_bias_acc:0.8180,validation_error:1.7704
...
class SubDifferentialNet3(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.in_channel_conv1 = nn.Sequential(
            nn.Conv2d(in_channels=in_channel, out_channels=out_channel, kernel_size=(5, 5)))
