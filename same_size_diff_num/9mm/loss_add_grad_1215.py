...
def train_loop(net, opt, loss_fn):
    ...
    train_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_distance9/train')
    ...
    validation_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_distance9/validation')
    ...
    print("train")
    epochs = 2000
    path = '/home/work3/tj/DOA/save/same_size_diff_num/0416'
