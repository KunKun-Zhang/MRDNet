...
# test_loss:415.9347, test_acc:0.2585, test_bias_acc:0.8582, test_error:1.6250
...
def train_loop(net, opt, loss_fn):
    ...
    # train_data = WavDataset(file_path='F:\\soundID\\DOAdata\\all_direction_oneFileAllDirection_onlySingleFrame_2200_no_snr_no_preprocess_lowfilter_mic8x8')
    train_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_5db_normalize_lowfilter_mic10x10/train')
    ...
    # validation_data = WavDataset(file_path='F:\\soundID\\DOAdata\\all_direction_oneFileAllDirection_onlySingleFrame_2200_no_snr_no_preprocess_lowfilter_mic8x8')
    validation_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_5db_normalize_lowfilter_mic10x10/train')
    ...
    test_loss, test_acc, test_error, test_bias_acc = differential_validation(net, loss_fn, validation_loader, device)
    print(
        f'test_loss:{test_loss:.4f}, test_acc:{test_acc:.4f}, test_bias_acc:{test_bias_acc:.4f}, test_error:{test_error:.4f}')
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/home/work3/tj/DOA/save/0220/differential_net25.pth'))
    print(model)
