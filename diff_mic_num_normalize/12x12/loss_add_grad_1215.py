...
def train_loop(net, opt, loss_fn):
    ...
    train_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_mic12x12/train')
    ...
    validation_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_0db_normalize_lowfilter_mic12x12/validation')
