...
def train_loop(net, opt, loss_fn):
    ...
    validation_data = WavDataset(file_path='/home/ssd02/all_direction_oneFileAllDirection_onlySingleFrame_2200_5db_normalize_lowfilter_mic10x10/validation')
